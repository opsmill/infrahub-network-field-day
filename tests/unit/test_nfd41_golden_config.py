"""Render the NFD41 host_vars with PyAVD and diff against the deployed lab.

This is the fast half of the parity claim. ``tests/integration/test_nfd41_fabric.py``
