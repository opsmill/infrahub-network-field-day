...
class GenerateFabricPeeringQueryTargetEdgesNodeClusterNodeNodesEdgesNodeComputePhysicalServerInterfacesEdgesNodeInterfacePhysicalConnectorNodeNetworkLinkConnectedEndpointsEdgesNodeInterfacePhysicalDeviceNodeDcimDevice(
    ...
    interfaces: "GenerateFabricPeeringQueryTargetEdgesNodeClusterNodeNodesEdgesNodeComputePhysicalServerInterfacesEdgesNodeInterfacePhysicalConnectorNodeNetworkLinkConnectedEndpointsEdgesNodeInterfacePhysicalDeviceNodeDcimDeviceInterfaces"
...
class GenerateFabricPeeringQueryTargetEdgesNodeClusterNodeNodesEdgesNodeComputePhysicalServerInterfacesEdgesNodeInterfacePhysicalConnectorNodeNetworkLinkConnectedEndpointsEdgesNodeInterfacePhysicalDeviceNodeDcimDeviceInterfaces(
    BaseModel
):
    edges: Optional[
        list[
            "GenerateFabricPeeringQueryTargetEdgesNodeClusterNodeNodesEdgesNodeComputePhysicalServerInterfacesEdgesNodeInterfacePhysicalConnectorNodeNetworkLinkConnectedEndpointsEdgesNodeInterfacePhysicalDeviceNodeDcimDeviceInterfacesEdges"
        ]
    ]


class GenerateFabricPeeringQueryTargetEdgesNodeClusterNodeNodesEdgesNodeComputePhysicalServerInterfacesEdgesNodeInterfacePhysicalConnectorNodeNetworkLinkConnectedEndpointsEdgesNodeInterfacePhysicalDeviceNodeDcimDeviceInterfacesEdges(
    BaseModel
):
    node: Optional[
        Annotated[
            Union[
                "GenerateFabricPeeringQueryTargetEdgesNodeClusterNodeNodesEdgesNodeComputePhysicalServerInterfacesEdgesNodeInterfacePhysicalConnectorNodeNetworkLinkConnectedEndpointsEdgesNodeInterfacePhysicalDeviceNodeDcimDeviceInterfacesEdgesNodeDcimInterface",
                "GenerateFabricPeeringQueryTargetEdgesNodeClusterNodeNodesEdgesNodeComputePhysicalServerInterfacesEdgesNodeInterfacePhysicalConnectorNodeNetworkLinkConnectedEndpointsEdgesNodeInterfacePhysicalDeviceNodeDcimDeviceInterfacesEdgesNodeInterfaceVirtual",
            ],
            Field(discriminator="typename__"),
        ]
    ]
...
class GenerateFabricPeeringQueryTargetEdgesNodeClusterNodeNodesEdgesNodeComputePhysicalServerInterfacesEdgesNodeInterfacePhysicalConnectorNodeNetworkLinkConnectedEndpointsEdgesNodeInterfacePhysicalDeviceNodeDcimDeviceInterfacesEdgesNodeDcimInterface(
    BaseModel
):
    typename__: Literal[
        "DcimInterface",
...
class GenerateFabricPeeringQueryTargetEdgesNodeClusterNodeNodesEdgesNodeComputePhysicalServerInterfacesEdgesNodeInterfacePhysicalConnectorNodeNetworkLinkConnectedEndpointsEdgesNodeInterfacePhysicalDeviceNodeDcimDeviceInterfacesEdgesNodeInterfaceVirtual(
    BaseModel
):
    typename__: Literal["InterfaceVirtual"] = Field(alias="__typename")
    id: str
    name: Optional[
        "GenerateFabricPeeringQueryTargetEdgesNodeClusterNodeNodesEdgesNodeComputePhysicalServerInterfacesEdgesNodeInterfacePhysicalConnectorNodeNetworkLinkConnectedEndpointsEdgesNodeInterfacePhysicalDeviceNodeDcimDeviceInterfacesEdgesNodeInterfaceVirtualName"
    ]
    role: Optional[
        "GenerateFabricPeeringQueryTargetEdgesNodeClusterNodeNodesEdgesNodeComputePhysicalServerInterfacesEdgesNodeInterfacePhysicalConnectorNodeNetworkLinkConnectedEndpointsEdgesNodeInterfacePhysicalDeviceNodeDcimDeviceInterfacesEdgesNodeInterfaceVirtualRole"
    ]
    ip_addresses: ""


class GenerateFabricPeeringQueryTargetEdgesNodeClusterNodeNodesEdgesNodeComputePhysicalServerInterfacesEdgesNodeInterfacePhysicalConnectorNodeNetworkLinkConnectedEndpointsEdgesNodeInterfacePhysicalDeviceNodeDcimDeviceInterfacesEdgesNodeInterfaceVirtualName(
    BaseModel
):
    value: Optional[str]


class GenerateFabricPeeringQueryTargetEdgesNodeClusterNodeNodesEdgesNodeComputePhysicalServerInterfacesEdgesNodeInterfacePhysicalConnectorNodeNetworkLinkConnectedEndpointsEdgesNodeInterfacePhysicalDeviceNodeDcimDeviceInterfacesEdgesNodeInterfaceVirtualRole(
    BaseModel
):
    value: Optional[str]


class (
    BaseModel
):
    edges: list[
        ""
    ]


class (
    BaseModel
):
    node: Optional[
        ""
    ]


class (
    BaseModel
):
    id: str
    address: Optional[
        ""
    ]


class (
    BaseModel
):
    value: Optional[str]
...
GenerateFabricPeeringQueryTargetEdgesNodeClusterNodeNodesEdgesNodeComputePhysicalServerInterfacesEdgesNodeInterfacePhysicalConnectorNodeNetworkLinkConnectedEndpointsEdgesNodeInterfacePhysicalDeviceNodeDcimDeviceInterfaces.model_rebuild()
GenerateFabricPeeringQueryTargetEdgesNodeClusterNodeNodesEdgesNodeComputePhysicalServerInterfacesEdgesNodeInterfacePhysicalConnectorNodeNetworkLinkConnectedEndpointsEdgesNodeInterfacePhysicalDeviceNodeDcimDeviceInterfacesEdges.model_rebuild()
GenerateFabricPeeringQueryTargetEdgesNodeClusterNodeNodesEdgesNodeComputePhysicalServerInterfacesEdgesNodeInterfacePhysicalConnectorNodeNetworkLinkConnectedEndpointsEdgesNodeInterfacePhysicalDeviceNodeDcimDeviceInterfacesEdgesNodeInterfaceVirtual.model_rebuild()
.model_rebuild()
.model_rebuild()
.model_rebuild()
